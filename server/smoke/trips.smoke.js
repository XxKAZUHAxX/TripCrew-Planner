...
try {
  ...
  assert(joined.status === 200 && joined.data.trip.members.length === 2, 'bob joins via code');
  ...
  assert(aliceToggle.status === 200 && aliceToggle.data.trip.inviteActive === false, 'creator toggles invite off');
